...
gem 'doorkeeper-openid_connect', '~> 1.8.2'
gem 'rexml', '~> 3.2.5'
...
gem 'graphql-docs', '~> 1.6.1', group: [:development, :test]
...
group :development do
  ...
  gem 'solargraph', '~> 0.43', '>= 0.43.1', require: false
...
group :test do
  ...
  gem 'derailed_benchmarks', '>= 2.0.0', require: false
end
